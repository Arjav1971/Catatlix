        ...
        <div className='table-head'>
            ...
            <div className='button-block'>
                <div className='duration-container'>
                    <div className={`span-content ${selectedDuration === 'Today' ? 'selected' : ''}`}  >
                          Today
                    </div>
                    <div className="divider"></div>
                    <div className={`span-content ${selectedDuration === 'Yesterday' ? 'selected' : ''}`}  >
                          Yesterday
                    </div>
                    <div className="divider"></div>
                    <div className={`span-content ${selectedDuration === 'Week' ? 'selected' : ''}`} >
                         Week
                    </div>
                    <div className="divider"></div>
                    <div className={`span-content ${selectedDuration === 'Month' ? 'selected' : ''}`}  >
                         Month
                    </div>
                    <div className="divider"></div>
                    <div className={`span-content ${selectedDuration === 'Quarter' ? 'selected' : ''}`}  >
                         Quarter
                    </div>
                    <div className="divider"></div>
                    <div className={`span-content ${selectedDuration === 'Year' ? 'selected' : ''}`}  >
                         Year
                    </div>
                </div>
                
                <Select className="period" defaultValue="Month" onChange={handleDurationChange}>
